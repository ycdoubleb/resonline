...
<div class="rescenter-default-index">
    <div class="list">
        ...
        <?php $filename = pathinfo($file->oss_key,PATHINFO_BASENAME) ?>
        <div class="res-tile" title="<?= $file->name ?>">
            ...
            <div class="name-box">
                ...
                <a class="download" href="<?= urlencode("download://resource/$file->name/$file->id/$filename/$file->updated_at/$file->size/") ?>">下载</a>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
